...
class BaselineNetwork(nn.Module):
    ...
    def forward(self, observations):
        ...
        # Baseline network is used to estimate the state value so that we can substract it from returns of each action to reduce gradient variance.
    ...
    def calculate_advantage(self, returns, observations):
        ...
        advantages = returns - self(observations=observations).detach().numpy()
        #########          END YOUR CODE.          ############
        return advantages
    ...
    def update_baseline(self, returns, observations):
        ...
        loss = torch.nn.functional.mse_loss(returns, self(observations))
